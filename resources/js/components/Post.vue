...
<template>
    <div class="bg-white rounded shadow w-2/3 mt-6 overflow-hidden">
        ...
        <div class="w-full" v-if="post.data.attributes.image.lenght">
        ...
        <div class="flex justify-between border-1 border-gray-400 m-4">
            <button :class="[post.data.attributes.likes.user_likes_post ? 'bg-blue-600 text-white' : '']"
        ...
        <div v-if="comments" class="border-t border-gray-400 p-4 pt-2">
            ...
            <div class="flex my-4 items-center" v-for="comment in post.data.attributes.comments.data" :key="comment.comment_id">
                <div class="w-8">
